...
) ENGINE=InnoDB AUTO_INCREMENT=147536 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=9698 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=158631 DEFAULT CHARSET=utf8;
...
CREATE TABLE `timetables` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_emu_dev.timetables_on_person_id` (`person_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5295 DEFAULT CHARSET=utf8;
